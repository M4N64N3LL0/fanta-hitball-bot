...
def scraper_professionale():
    ...
    giocatori_data = {}
    print("=== AVVIO MEGA-BOT (REGOLAMENTO COMPLETO) ===")
        ...
        for l in links:
            ...
            if len(team_lists) >= 2:
                ...
                if "tavolino" in sp.text.lower():
                    # Se c'è un tavolino, penalizza SOLO la squadra che non ha fatto punti a referto
                ...
                # Accoppiamo i giocatori con i loro bonus/malus di squadra
